...
"""
appsembler-credentials-extensions documentation build configuration file.
...
project = 'appsembler-credentials-extensions'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'Appsembler Open edX Credentials Extensions'
...
#
# html_title = 'appsembler-credentials-extensions v0.1.0'
...
texinfo_documents = [
    (master_doc, project_title, documentation_title,
     author, project_title, 'Common package with apps for extensions for Open edX course/program certificates, badges, and other credentials types TBD.',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'appsembler_credentials_extensions'),
                os.path.join(root_path, 'appsembler_credentials_extensions/migrations')])
